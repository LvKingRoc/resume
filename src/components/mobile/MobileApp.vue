...
import { ref } from 'vue'
import { personalInfo, education, skillCategories, projects, experience, selfEvaluationBackend as selfEvaluation, honors, campusRoles, internship } from '@/data/resume'
    ...
    <main class="m-main">
      ...
      <section id="m-hero" class="m-section m-hero">
        <div class="m-hero__top">
          ...
          <div class="m-hero__right">
            ...
            <div class="m-hero__contact">
              ...
              <div 
                class="m-hero__contact-item"
                :class="{ 'm-hero__contact-item--copied': copiedField === 'github' }"
                @click="copyToClipboard('https://github.com/lvkingroc', 'github')"
              >
                ...
                <span class="m-hero__contact-copy">
                  <svg v-if="copiedField === 'github'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
                  <svg v-else viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
                </span>
              </div>
            </div>
        ...
        <div class="m-hero__stats">
          ...
          <div class="m-hero__stat">
            <span class="m-hero__stat-value">1.5年</span>
            <span class="m-hero__stat-label">实习</span>
          </div>
        </div>
      </section>
      ...
      <section id="m-experience" class="m-section">
        <h2 class="m-section__title">经历</h2>

        <!-- 实习经历 -->
        <div class="m-experience__card" style="margin-bottom: 12px;">
          <div class="m-experience__school-header">
            <span class="m-experience__school-name">{{ internship.company }}</span>
            <span class="m-experience__school-period">{{ internship.period }}</span>
          </div>
          <span class="m-experience__school-role">{{ internship.position }}</span>
          <div class="m-experience__internship-projects">
            <span 
              v-for="(project, idx) in internship.projects" 
              :key="idx"
              class="m-experience__internship-tag"
            >
              {{ project }}
            </span>
          </div>
