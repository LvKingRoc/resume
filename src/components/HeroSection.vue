...
const contactItems = [
  ...
  { icon: 'github', label: 'GitHub', value: 'github.com/lvkingroc', displayValue: 'github.com/lvkingroc', copyValue: 'https://github.com/lvkingroc' }
]
    ...
    <div class="hero__container">
        ...
        <div class="hero__contact">
          ...
          >
            <span class="hero__contact-icon">
              ...
              <svg v-else-if="item.icon === 'github'" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="hero__visual">
        ...
        <div class="hero__stats">
          ...
          <div class="hero__stat">
            <span class="hero__stat-value">1.5年</span>
            <span class="hero__stat-label">实习经验</span>
          </div>
        </div>
      </div>
    </div>
